...
<body>
  <div class="wrap">
    <div class="header_top">
      <div class="logo">
        <a href="index.php"><img src="images/logo1.png" alt="" style="width: 200px;height: 120px;object-fit: cover;" /></a>
      </div>
...
if ($login == false) {
    ...
    <a href="login.php">Login</a>
     <input type="hidden" class="session" value="0"> 
<?php
} else {
        ?>
         <input type="hidden" class="session" value="<?php echo Session::get('cmrId'); ?>"> 
